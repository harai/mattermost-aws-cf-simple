...
def component():
  return imagebuilder.Component(
      'Component',
      Data=Sub(util.get_content('mattermost/ami/resources/component.yaml')),
      Name=StackName,
      Platform='Linux',
      Version=util.get_content('mattermost/common/AUTO_VERSION'))
...
def infrastructure_configuration(
  ...
  return imagebuilder.InfrastructureConfiguration(
      ...
      DependsOn=[route_internet.name, subnet_route_table_association.name],
